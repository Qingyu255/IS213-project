...
async def update_event_endpoint(event_id: UUID4, event: EventUpdate, db: AsyncSession = Depends(get_db)):
    """
...
async def delete_event_endpoint(event_id: UUID4, db: AsyncSession = Depends(get_db)):
    """
